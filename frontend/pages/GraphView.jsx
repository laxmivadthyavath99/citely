...
/**
 * Very small force-directed layout: repulsion between all nodes,
 * spring attraction along edges, mild pull toward center.
 * Good enough for tens of nodes without pulling in d3-force as a dependency.
 */
function useForceLayout(nodes, edges) {
  ...
  useEffect(() => {
    ...
    // seed positions that don't already have one
    nodes.forEach((n, i) => {
